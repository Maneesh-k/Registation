...
public class StudentDataView extends javax.swing.JFrame {
    ...
    /**
     * Creates new form StudentDataView
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentDataView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentDataView().setVisible(true);
            }
        });
    }
