 ...
 * @author ELCOT
 */
public class UserCourseDetails extends javax.swing.JFrame {

    /**
     * Creates new form UserCourseDetails
     */
 ...
 private void DisplayTable(){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        UserOptionForm adminoptionform=new UserOptionForm();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserCourseDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserCourseDetails().setVisible(true);
            }
        });
    }
