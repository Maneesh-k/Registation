 ...
 * @author ELCOT
 */
public class AdminCoursedetails extends javax.swing.JFrame {
...
private void DisplayTable(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminCoursedetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminCoursedetails().setVisible(true);
            }
        });
    }
